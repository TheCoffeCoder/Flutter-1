  ...
  Future fetchData() async {
    ...
    var response = WpConfig.blockedCategoryIds.isEmpty
        ? await http.get(Uri.parse(
            "${WpConfig.websiteUrl}/wp-json/wp/v2/posts?_embed&page=1&per_page=$_contentAmount"))
        : await http.get(Uri.parse(
            "${WpConfig.websiteUrl}/wp-json/wp/v2/posts?=${WpConfig.featuredTagID}&per_page=$_contentAmount&categories_exclude=" +
